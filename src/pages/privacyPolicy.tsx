...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen px-12 py-10 bg-radial-gradient">
      ...
      <p className="mt-4">Last updated: May 25, 2024</p>
      <p className="px-2 py-2 text-textclr/40">
      ...
      <h2 className="mt-6 text-2xl font-primaryBold text-textclr2">
        Interpretation and Definitions
      </h2>
      <h3 className="mt-4 text-xl font-primaryBold text-textclr2">
        Interpretation
      </h3>
      <p className="px-2 py-2 text-textclr/40">
      ...
      <ul className="list-disc list-inside">
        <li className="px-2 py-2 text-textclr/40">
        ...
        <li className="px-2 py-2 text-textclr/40">
          ...
          this Agreement) refers to Prnt LLC, TBD.
        </li>
        <li className="px-2 py-2 text-textclr/40">
        ...
        <li className="px-2 py-2 text-textclr/40">
          <strong>Website</strong> refers to Prnt Hub, accessible from{" "}
          <a
            href="https://www.prnthub.com/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://www.prnthub.com/
          </a>
        </li>
        <li className="px-2 py-2 text-textclr/40">
      ...
      <h4 className="mt-4 text-lg font-primaryBold text-textclr2">
        Personal Data
      </h4>
      <p className="px-2 py-2 text-textclr/40">
      ...
      <ul className="list-disc list-inside">
        <li className="px-2 py-2 text-textclr/40">Usage Data</li>
      </ul>
      <h4 className="mt-4 text-lg font-primaryBold text-textclr2">
        Usage Data
      </h4>
      ...
      <ul className="list-disc list-inside">
        <li className="px-2 py-2 text-textclr/40">
          ...
          <ul className="ml-4 list-none">
            <li className="px-2 py-2 text-textclr/40">Type: Session Cookies</li>
            <li className="px-2 py-2 text-textclr/40">Administered by: Us</li>
            <li className="px-2 py-2 text-textclr/40">
