...
const Dashboard = () => {
  ...
  return (
    <>
        ...
        <Box sx={{ width: "100%" }}>
          ...
          {value === 0 && (
            <motion.div
              ...
              layout
            >
              <h2 className="mb-4 text-3xl text-center font-primaryBold text-textclr2">
                Approvals
              </h2>
              ...
              <table className="table w-full text-textclr2">
                <thead>
                  <tr className="text-lg font-primaryRegular text-textclr2">
            ...
            >
              ...
              <div className="overflow-x-auto">
                <table className="table text-textclr2">
                  ...
                  <tbody className="font-primaryRegular text-textclr">
                    {projects
                      .filter((e) => {
                        if (
          ...
          {value === 3 && (
            ...
            >
              ...
              <h2 className="mb-4 text-xl text-left font-primaryRegular text-textclr">
                Mint Address
              </h2>
              <input
                type="text"
              ...
              />
              <h2 className="my-4 mb-4 text-2xl text-left font-primaryRegular text-textclr">
                Token Name
              </h2>
              <input
                type="text"
          ...
          {value === 4 && (
            ...
            >
              ...
              <input
                ...
                className="block mt-2 w-full placeholder-gray-400/70 dark:placeholder-gray-500 rounded-lg border border-textclr2 bg-white px-5 py-2.5 text-gray-700 focus:border-textclr2 focus:outline-none focus:ring focus:ring-textclr2 focus:ring-opacity-40 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-textclr2"
              />
              <h2 className="my-4 mb-4 text-xl text-left font-primaryRegular text-textclr">
                Token Name
              </h2>
              <input
                type="text"
      ...
      <div className="justify-center block py-1 text-[0.7rem] italic text-center text-white/70 md:hidden bg-lime-700">
